...
The CPU cores, L2 Cache, and AMBA infrastructure are clocked from the MSS PLL through a set of dividers. During normal operation, the PLL clock is divided by 1 for the CPU cores, by 2 for the L2 Cache and AXI bus, and by 4 for the AHB/APB bus.
